...
public class CalendarView extends Activity {
    ...
    public static GregorianCalendar itemmonth;
        ...
        gridview.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                for (int i = 0; i < Utility.eventData.size(); i++) {
                    if (Utility.eventData.get(i).getStartDate().equals(selectedGridDate)) {
                        desc.add(Utility.eventData.get(i).getName());
                    }
                }
    ...
    public Runnable calendarUpdater = new Runnable() {
        ...
        public void run() {
            items.clear();
            Log.d("CalendarView.calendarUpdate", "I am here 2");
            ...
            for (int i = 0; i < Utility.eventData.size(); i++) {
                ...
                items.add(MainActivity.eventList.get(i).getStartDate().split(" ")[0]);
            }
