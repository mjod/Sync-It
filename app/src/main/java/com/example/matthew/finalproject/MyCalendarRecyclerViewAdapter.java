...
public class MyCalendarRecyclerViewAdapter extends RecyclerView.Adapter<MyCalendarRecyclerViewAdapter.ViewHolder> {
    ...
    public MyCalendarRecyclerViewAdapter(Context myContext, ArrayList myDataSet) {
        mContext = myContext;
        if (myDataSet != null)
            setItems(myDataSet);
    }
    ...
    public MyCalendarRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                               int viewType) {
        View v;
